<div>
  <div class="col-md-12"  ng-show="displayMode">
    <div class="panel panel-blue">
      <div class="panel-heading dark-overlay"><span class="glyphicon glyphicon-check"></span>Designation List</div>
  ...
  <div class="col-md-12"  ng-show="createMode">
    <form role="form">
      <div class="form-group">
        <label>Name</label>
        <input class="form-control" placeholder="Designation name" ng-model="newDesignation.name">
      </div>
  ...
  <div class="col-md-12"  ng-show="updateMode">
    <form role="form">
      ...
      <div class="form-group">
        <label>Name</label>
        <input class="form-control" placeholder="Designation name" ng-model="updateDesignation.name">
      </div>
