...
<html ng-app="reviewStatusApp">
<head>
  <title>Review Status CRUD interface</title>
  ...
  <script src="<c:url value="/resources/js/reviewStatus.js" />"></script>
</head>
<body ng-controller="reviewStatusController">
<button ng-click="switchToCreateMode()">Add new Review Status</button>
<br>
<div ng-show="createMode">
  <form>
    <input type="text" name="Name" ng-model="newReviewStatus.name"/>
...
<div ng-show="updateMode">
  <input type="text" name="Name" ng-model="updateReviewStatus.name"/>
