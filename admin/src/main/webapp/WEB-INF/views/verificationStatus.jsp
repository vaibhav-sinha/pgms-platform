...
<html ng-app="verificationStatusApp">
<head>
  <title>Verification Status CRUD interface</title>
  ...
  <script src="<c:url value="/resources/js/verificationStatus.js" />"></script>
</head>
<body ng-controller="verificationStatusController">
<button ng-click="switchToCreateMode()">Add new Verification Status</button>
<br>
<div ng-show="createMode">
  <form>
    <input type="text" name="Name" ng-model="newVerificationStatus.name"/>
...
<div ng-show="updateMode">
  <input type="text" name="Name" ng-model="updateVerificationStatus.name"/>
