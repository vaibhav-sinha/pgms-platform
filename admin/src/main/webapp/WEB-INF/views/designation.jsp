...
<html ng-app="designationApp">
<head>
    <title>Designation CRUD interface</title>
    ...
    <script src="<c:url value="/resources/js/designation.js" />"></script>
</head>
<body ng-controller="designationController">
<button ng-click="switchToCreateMode()">Add new Designation</button>
<br>
<div ng-show="createMode">
    <form>
        <input type="text" name="Name" ng-model="newDesignation.name"/>
...
<div ng-show="updateMode">
    <input type="text" name="Name" ng-model="updateDesignation.name"/>
