...
public class ComplaintServiceImpl implements ComplaintService {
    ...
    public Complaint saveComplaint(Complaint complaint) {
        ...
        return mapper.map(complaintRepository.save(complaintEntity), Complaint.class);
    }
    ...
    public List<Complaint> getComplaintsForFilter(PgmsComplaintFilter pgmsComplaintFilter) {
        ...
        else if(pgmsComplaintFilter.getCategoryId() != null) {
        ...
        if(pgmsComplaintFilter.getComplaintStatus() != null) {
            criteria.and("complaint.complaintStatus").is(pgmsComplaintFilter.getComplaintStatus());
        }
